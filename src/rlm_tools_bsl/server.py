...
def _rlm_start(
    ...
    if idx_stats:
        ...
        index_block: dict = {
            ...
            "v8unpack_metadata_status": idx_stats.get("v8unpack_metadata_status"),
            "v8unpack_metadata_version": idx_stats.get("v8unpack_metadata_version"),
            "v8unpack_metadata_producer_version": idx_stats.get("v8unpack_metadata_producer_version"),
            "v8unpack_metadata_object_version": idx_stats.get("v8unpack_metadata_object_version"),
            "v8unpack_metadata_identity_total": idx_stats.get("v8unpack_metadata_identity_total"),
            "v8unpack_metadata_identity_indexed": idx_stats.get("v8unpack_metadata_identity_indexed"),
            "v8unpack_metadata_identity_failed": idx_stats.get("v8unpack_metadata_identity_failed"),
            "v8unpack_metadata_structural_total": idx_stats.get("v8unpack_metadata_structural_total"),
            "v8unpack_metadata_structural_indexed": idx_stats.get("v8unpack_metadata_structural_indexed"),
            "v8unpack_metadata_structural_failed": idx_stats.get("v8unpack_metadata_structural_failed"),
            "v8unpack_metadata_facet_total": idx_stats.get("v8unpack_metadata_facet_total"),
            "v8unpack_metadata_facet_supported": idx_stats.get("v8unpack_metadata_facet_supported"),
